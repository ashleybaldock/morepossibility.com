...
export const Puzzle = ({
  ...
  return (
    <svg className={`${styles.theSVG} ${className}`} viewBox="0 0 1275.129 1257.125" {...props}>
    ...
    C813.893,826.874,849.259,764.207,872.722,701.024z"
      ...
      <g className={styles.text}>
        <g className={styles.top}>
          <g className={styles.first}>
            <text x="353.6114959716797" y="441.16650390625" className={styles.a}>{`Text for a`}</text>
            <text x="450.53700256347656" y="383.0904998779297" className={styles.b}>{`Text for b`}</text>
            <text x="544.1394805908203" y="325.802001953125" className={styles.c}>{`Text for c`}</text>
            <text x="637.9219970703125" y="269.1269989013672" className={styles.d}>{`Text for d`}</text>
          </g>
          <g className={styles.second}>
            <text x="448.62200927734375" y="499.0484924316406" className={styles.e}>{`Text for e`}</text>
            <text x="545.3330078125" y="441.4029998779297" className={styles.f}>{`Text for f`}</text>
            <text x="639.5034790039062" y="384.0585021972656" className={styles.g}>{`Text for g`}</text>
            <text x="733.5690002441406" y="327.5084991455078" className={styles.h}>{`Text for h`}</text>
          </g>
          <g className={styles.third}>
            <text x="544.2655029296875" y="557.8515014648438" className={styles.i}>{`Text for i`}</text>
            <text x="640.1115112304688" y="500.25" className={styles.j}>{`Text for j`}</text>
            <text x="827.91748046875" y="385.6264953613281" className={styles.k}>{`Text for k`}</text>
          </g>
          <g className={styles.fourth}>
            <text x="829.4045104980469" y="500.1120147705078" className={styles.l}>{`Text for l`}</text>
            <text x="923.1744995117188" y="443.2825012207031" className={styles.m}>{`Text for m`}</text>
            <text x="639.552490234375" y="615.4234924316406" className={styles.n}>{`Text for n`}</text>
            <text x="734.9509887695312" y="558.0855102539062" className={styles.o}>{`Text for o`}</text>
          </g>
        </g>

        <g className={styles.left}>
          <g className={styles.alpha}>
            <text x="327.01145935058594" y="557.8215179443359" className={styles.w}>{`Text for w`}</text>
          </g>
          <g className={styles.beta}>
            <text x="361.0179748535156" y="763.968017578125" className={styles.x}>{`Text for x`}</text>
            <text x="474.60301208496094" y="640.0670166015625" className={styles.y}>{`Text for y`}</text>
          </g>
          <g className={styles.gamma}>
            <text x="564.0505065917969" y="748.0890197753906" className={styles.z}>{`Text for z`}</text>
            <text x="511.0149841308594" y="918.9419860839844" className={styles._}>{`Text for _`}</text>
          </g>
        </g>

        <g className={styles.right}>
          <g className={styles.mind}>
            <text x="690.7624816894531" y="814.7044677734375" className={styles.p}>{`Text for p`}</text>
            <text x="712.6759948730469" y="1002.1845092773438" className={styles.q}>{`Text for q`}</text>
          </g>
          <g className={styles.body}>
            <text x="809.007568359375" y="729.5519714355469" className={styles.r}>{`Text for r`}</text>
            <text x="832.2174987792969" y="893.1989440917969" className={styles.s}>{`Text for s`}</text>
          </g>
          <g className={styles.spirit}>
            <text x="954.1369934082031" y="824.2044982910156" className={styles.t}>{`Text for t`}</text>
            <text x="875.8674621582031" y="599.9639587402344" className={styles.u}>{`Text for u`}</text>
            <text x="952.843017578125" y="588.1234588623047" className={styles.v}>{`Text for v`}</text>
          </g>
        </g>
      </g>
    </svg>
